...
//Appended win screen dialogue to support deepbluezen's implementation
===Endgame===
KosmosAI.Print(Sys_report)
...
* [Close system message]
    KosmosAI.Speech()
    Great job, [NAME: PHY-5-OH]! Our systems are back to normal, and our crew is safely on path back to Earth. And they NEVER needed or WILL NEED to know!
